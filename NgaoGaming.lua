...
local Window = OrionLib:MakeWindow({Name = "Ngáo Gaming", HidePremium = false, IntroText = "NgáoGaming Library", SaveConfig = true, ConfigFolder = "Ngáo Gaming Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://16225571356",
    PremiumOnly = false
})
